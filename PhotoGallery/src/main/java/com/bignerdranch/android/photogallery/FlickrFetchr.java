...
public class FlickrFetchr {
    ...
    private static final String EXTRAS_SMALL_URL = "url_s";
    ...
    public ArrayList<GalleryItem> fetchItems(Integer page){
        ...
        try{
            String url = Uri.parse(ENDPOINT).buildUpon()
                    ...
                    .appendQueryParameter(PARAM_EXTRAS,EXTRAS_SMALL_URL)
    ...
    public void parseItems(ArrayList<GalleryItem> items, XmlPullParser parser) throws XmlPullParserException, IOException{
        ...
        while(eventType != XmlPullParser.END_DOCUMENT){
            if((eventType == XmlPullParser.START_TAG) && XML_PHOTO.equals(parser.getName())){
                ...
                String smallUrl = parser.getAttributeValue(null, EXTRAS_SMALL_URL);
